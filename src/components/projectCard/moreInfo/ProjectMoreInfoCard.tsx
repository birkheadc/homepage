...
export default function ProjectMoreInfoCard(props: ProjectMoreInfoCardProps): JSX.Element {
  ...
  return (
    <div className='flex flex-col items-center justify-start w-fit h-fit max-w-[600px] max-h-[90svh] m-auto bg-primary-3 text-primary-1 border-2 overflow-y-auto'>
