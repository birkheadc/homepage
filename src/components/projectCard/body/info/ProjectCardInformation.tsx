...
export default function ProjectCardInformation(props: ProjectCardInformationProps): JSX.Element {
  ...
  return (
    <div className={utils.cn('absolute inset-0 z-10 flex flex-col items-center justify-between transition-all bg-opacity-75 opacity-0 hocus-within:opacity-100 hover:opacity-100 backdrop-blur-sm bg-primary-3', styles.information)}>
