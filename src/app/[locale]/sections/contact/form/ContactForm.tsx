  ...
  return (
    <form className='relative w-full flex flex-col flex-grow max-w-2xl' onSubmit={handleSubmit}>
      ...
      <div className={`${isWorking ? 'pointer-events-none opacity-25' : ' pointer-events-auto opacity-100'} flex flex-col gap-6 w-full flex-grow`}>
        <div className='relative w-full text-xl border-2 border-primary-1 lg:text-2xl hocus-within:border-primary-0 hocus-within:text-primary-0'>
          <label className='absolute px-2 -top-[1.2rem] left-2 bg-primary-3' htmlFor='name'>name</label>
        ...
        <div className='flex-grow relative w-full text-xl border-2 border-primary-1 lg:text-2xl hocus-within:border-primary-0 hocus-within:text-primary-0'>
        ...
        <button className='p-1 pb-2 px-3 m-auto text-2xl border-2 bg-primary-1 text-primary-3 w-fit lg:text-3xl hocus:bg-primary-2 hocus:text-primary-0 border-primary-0' disabled={isWorking} type='submit'>submit</button>
      </div>
    </form>
  );
}