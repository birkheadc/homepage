  ...
  return (
    <div className='relative w-full min-h-[80svh]'>
      ...
      <div className='absolute bottom-0 w-full max-w-full max-h-full short:w-1/2 lg:w-1/2'>
        <PixelatedImage ariaLabel='picture of Colby Birkhead' className='w-full h-full -translate-x-[20%] -translate-y-[10%] scale-125 lg:translate-x-0 lg:translate-y-0 lg:scale-100 short:translate-x-0 short:translate-y-0 short:scale-100' img={'/colby/400.png'} shaderMode={ImageProcessShaderMode.NORMAL} pixelLevel={1} />
      </div>
    </div>
  );
}